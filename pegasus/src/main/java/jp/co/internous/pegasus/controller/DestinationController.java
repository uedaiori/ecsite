...
import jp.co.internous.pegasus.model.domain.MstDestination;
import jp.co.internous.pegasus.model.domain.MstUser;
import jp.co.internous.pegasus.model.form.DestinationForm;
import jp.co.internous.pegasus.model.mapper.MstDestinationMapper;
import jp.co.internous.pegasus.model.mapper.MstUserMapper;
import jp.co.internous.pegasus.model.session.LoginSession;

@Controller
@RequestMapping("/pegasus/destination")
